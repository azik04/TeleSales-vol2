...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeleSales.DataProvider.Entities.List.Results", b =>
                {
                    ...
                    b.ToTable("List.CallResult", (string)null);
                });
            ...
            modelBuilder.Entity("TeleSales.DataProvider.Entities.List.Statuses", b =>
                {
                    ...
                    b.ToTable("List.CallStatus", (string)null);
                });
            ...
            modelBuilder.Entity("TeleSales.DataProvider.Entities.Main.CallCenters", b =>
                {
                    ...
                    b.ToTable("Main.CallCenter", (string)null);
                });
            ...
            modelBuilder.Entity("TeleSales.DataProvider.Entities.Main.Users", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            CreateAt = new DateTime(2025, 2, 7, 17, 52, 48, 519, DateTimeKind.Local).AddTicks(5939),
            ...
            modelBuilder.Entity("TeleSales.DataProvider.Entities.Main.Сhannels", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TeleSales.DataProvider.Entities.Main.CallCenters", b =>
                {
                    ...
                    b.HasOne("TeleSales.DataProvider.Entities.Main.Сhannels", "Сhannel")
                        .WithMany("CallCenter")
