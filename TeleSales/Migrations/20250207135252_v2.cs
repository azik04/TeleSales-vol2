...
namespace TeleSales.Migrations
{
    /// <inheritdoc />
    public partial class v2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_List.CallResult", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "List.CallStatus",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_List.CallStatus", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Main.Debitors_List.CallResult_ResultId",
                        column: x => x.ResultId,
                        principalTable: "List.CallResult",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Main.Debitors_List.CallStatus_StatusId",
                        column: x => x.StatusId,
                        principalTable: "List.CallStatus",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2025, 2, 7, 17, 52, 48, 519, DateTimeKind.Local).AddTicks(5939), "admin@adra.gov.az", "Admin", "Admin123", 2, false });
