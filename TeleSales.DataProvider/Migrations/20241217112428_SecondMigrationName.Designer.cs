...
namespace TeleSales.DataProvider.Migrations
{
    ...
    [Migration("20241217112428_SecondMigrationName")]
    partial class SecondMigrationName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeleSales.DataProvider.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1L,
                            CreateAt = new DateTime(2024, 12, 17, 15, 24, 28, 91, DateTimeKind.Local).AddTicks(8492),
